...
import { Coffee, Type, ImageIcon } from 'lucide-react';

export default function SupportBlock() {
  return (
    <div className="bg-gradient-to-r from-blue-100 to-gray-100 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        <Type className="w-12 h-12 text-blue-600 mx-auto mb-4" />
        <h2 className="text-3xl font-bold text-blue-600 mb-4">Support Our Work ❤️</h2>
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free font identifier by supporting us.
          Your contribution helps keep this tool free for all designers and typography enthusiasts! 🔤
        </p>
        <a
